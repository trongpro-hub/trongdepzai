...
local Window = OrionLib:MakeWindow({Name = "chưa nghĩ ra hub", HidePremium = false, IntroText = "chưanghĩrahub Library", SaveConfig = true, ConfigFolder = "chưa nghĩ ra hub"})

OrionLib:MakeNotification({
	Name = "chưa nghĩ ra hub",
	Content = "techcombank 9903042011",
...
W:AddLabel("Script By trong.dev")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("nhớ phải donate nhá")
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : Đell có")
